 ...
 * @author Petr Smejkal
 */
public abstract class BadFood extends Movable implements Serializable{

    protected abstract float getMass();

    public int diameter = 10;
    public int value = (int) (1000 + 400 * Math.random());
    
    public BadFood(float x, float y){
        super(x,y);
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.setColor(new Color(Math.max(0, Math.min(255,value/2 )),0,0));
