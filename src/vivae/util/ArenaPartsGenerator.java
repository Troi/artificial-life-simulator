...
public class ArenaPartsGenerator {
    ...
    public static Vector<ArenaPart> createParts(
            HashMap<String, Vector<Shape>> shapesWithTypeMap, int layer, TomArena arena) {
     ...
     */
    public static ArenaPart createPart(Shape shape, String type, int layer, TomArena arena) {
        Object[] constructorArgs = {shape, layer, arena};
        Class[] argTypes = {Shape.class, int.class, TomArena.class};
